              ...
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a MACH Branded Water Bottle
                  </Text>
                  <Pressable
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a set of MACH Stickers!
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a custom Temporary MACH Tattoo!
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a MACH Branded Coffee Cup
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a Team MACH Transition Towel
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a pair of MACH Running Shoes
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a pair of MACH Triathalon Shorts
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a MACH Triathalon Jersey
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a set of MACH Swimwear
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
                    onPress={() =>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve $150 In Store Credit for anything and everything
                    MACH Apparel
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    A Mystery Package sent to you directly from MACH HQ
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a NEW 2024 MACH Team Shirt
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
                    onPress={() =>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a Team MACH Triathalon Suit
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
                    onPress={() =>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a NEW set of 2024 Cycling Bibs
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a full Cycling Kit from MACH Apparel
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a TEAM MACH Triathalon Bag
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a Custom Made Race Week Shirt just for you straight
                    from MACH Apparel
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Recieve a FULL CUSTOM Triathalong straight from MACH Apparel
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    MACH will provide a full USAT Membership
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    MACH will sponsor you for 3 full Race Entries
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
                    onPress={() =>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    MACH will pay for ONE ROUND TRIP to any NORTH AMERICAN RACE{" "}
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Win a trip to train with PROFESSIONAL TRIATHELETES!
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    A Mystery Reward straight from MACH HQ
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
                    onPress={() => setModalVisibleMystery(!modalVisibleMystery)}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    MACH will send a videographer to you to film a full Day in
                    the Life segment all about you!
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    Win a trip to Kona, Hawaii for the World Championships
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <View style={styles.centeredView}>
                <View style={styles.modalView}>
                  <Text style={styles.modalText}>
                    You made it to the top! You have earned a FREE TEAM BUNDLE
                    for LIFE from MACH Apparel!
                  </Text>
                  <Pressable
                    style={[styles.backButton, styles.buttonClose]}
